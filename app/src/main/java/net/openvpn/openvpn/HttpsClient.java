...
public class HttpsClient {
    ...
    public static String checkStatus(String server_uri, String login_code, long bytes_in, long bytes_out) {
        try {
            ...
            OutputStreamWriter writer = new OutputStreamWriter(conn.getOutputStream());
            String params = "login_code=" + login_code + "&bytes_in=" + bytes_in + "&bytes_out=" + bytes_out;
            writer.write(params);
            writer.flush();
